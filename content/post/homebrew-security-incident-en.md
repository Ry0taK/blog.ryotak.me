...
3. If step 2 didn't match, check if it matches one of the following regular expressions and if it matches, replace the file path information of the source/destination according to the contents.
